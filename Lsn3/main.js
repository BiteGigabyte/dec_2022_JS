...
//
for(const mass_o of products)
{
    console.log(mass_o);
    // for(const blocks in mass_o)
    // {
        document.write(`<div class="product-card">`);
            document.write(`<h3 class="product-title">`);
                document.write(`${mass_o.title}. Price - ${mass_o.price}`);
            document.write(`</h3>`);
                document.write(`<img src=${mass_o.image} alt="" class="product-image">`);
            document.write(`<hr>`);
        document.write(`</div>`);
    // }
}
...
for (user of users) {
    ...
    //
document.write(`<h3>age: over thirty years;</h3>`);
for (user of users) {
    if (user["age"] >= 31) {
        document.write(`<h4>${user["name"]}</h4>`);
    }
